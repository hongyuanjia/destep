...
utils::globalVariables(c(
    ...
    "CONSTRUCTION", "COORDINATE_KEY", "FRACTION_RADIANT",
    "FRACTION_REPLACEABLE", "ID", "KIND_ENCLOSURE", "LAYER_NO",
    "MATERIAL_NAME", "MATERIAL_ID", "NAME", "ORIGINAL_NAME", "OUTPUT_ID",
    "PART", "PART_COUNT", "PLANE", "PRESERVE_BASE_NAME", "PROTECTED",
    "MIN_REQUIRE_FRESH_AIR", "N", "POINT_NO", "POINT_X", "POINT_Y",
    "POINT_Z", "ROOM", "ROOM_ID", "ROOM_NAME", "ROOMS", "SCHEDULE_NAME",
    "SENSIBLE_HEAT_FRACTION", "SIDE", "SOURCE_TABLE",
